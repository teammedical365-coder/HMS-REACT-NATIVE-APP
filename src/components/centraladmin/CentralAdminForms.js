...
export default function CentralAdminForms({
  ...
  if (showHospitalAdminForm) {
    // Placeholder for HospitalAdminHUDForm
    return (
      <View style={{ padding: 20, backgroundColor: '#fff', borderRadius: 12, marginTop: 20 }}>
        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>+ Add Hospital Admin</Text>
        <Text style={{ marginTop: 10 }}>Placeholder for HospitalAdminHUDForm</Text>
