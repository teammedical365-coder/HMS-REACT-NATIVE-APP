...
export const createDoctor = createAsyncThunk(
  ...
  async (doctorData, { rejectWithValue }) => {
    try {
      ...
      return response.success ? response.doctor : rejectWithValue(response.message);
    } catch (error) {
...
const adminEntitiesSlice = createSlice({
  name: 'adminEntities',
  initialState: {
    doctors: { data: [], loading: false, error: null },
    labs: { data: [], loading: false, error: null },
    pharmacies: { data: [], loading: false, error: null },
    receptions: { data: [], loading: false, error: null },
  ...
  extraReducers: (builder) => {
    builder
      // Doctors
      .addCase(fetchAdminDoctors.pending, (state) => { state.doctors.loading = true; state.doctors.error = null; })
      .addCase(fetchAdminDoctors.fulfilled, (state, action) => { state.doctors.loading = false; state.doctors.data = action.payload; })
      .addCase(fetchAdminDoctors.rejected, (state, action) => { state.doctors.loading = false; state.doctors.error = action.payload; })
      .addCase(createDoctor.fulfilled, (state, action) => { state.doctors.data.unshift(action.payload); })
      .addCase(updateDoctor.fulfilled, (state, action) => {
        const index = state.doctors.data.findIndex((d) => d._id === action.payload._id);
        if (index !== -1) state.doctors.data[index] = action.payload;
      })
      .addCase(deleteDoctor.fulfilled, (state, action) => {
        state.doctors.data = state.doctors.data.filter((d) => d._id !== action.payload);
      })
      // Labs
      .addCase(fetchLabs.pending, (state) => { state.labs.loading = true; state.labs.error = null; })
      .addCase(fetchLabs.fulfilled, (state, action) => { state.labs.loading = false; state.labs.data = action.payload; })
      .addCase(fetchLabs.rejected, (state, action) => { state.labs.loading = false; state.labs.error = action.payload; })
      // Pharmacies
      .addCase(fetchPharmacies.pending, (state) => { state.pharmacies.loading = true; state.pharmacies.error = null; })
      .addCase(fetchPharmacies.fulfilled, (state, action) => { state.pharmacies.loading = false; state.pharmacies.data = action.payload; })
      .addCase(fetchPharmacies.rejected, (state, action) => { state.pharmacies.loading = false; state.pharmacies.error = action.payload; })
      // Receptions
      .addCase(fetchReceptions.pending, (state) => { state.receptions.loading = true; state.receptions.error = null; })
      .addCase(fetchReceptions.fulfilled, (state, action) => { state.receptions.loading = false; state.receptions.data = action.payload; })
      .addCase(fetchReceptions.rejected, (state, action) => { state.receptions.loading = false; state.receptions.error = action.payload; })
      // Services
      .addCase(fetchAdminServices.pending, (state) => { state.services.loading = true; state.services.error = null; })
      .addCase(fetchAdminServices.fulfilled, (state, action) => { state.services.loading = false; state.services.data = action.payload; })
      .addCase(fetchAdminServices.rejected, (state, action) => { state.services.loading = false; state.services.error = action.payload; });
  },
});
